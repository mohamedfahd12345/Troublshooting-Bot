...
import { flowsToBeSetup } from './setup.js'
...
export class FlowCoordinator {
    ...
    getLocalFlowByTrigger(trigger, intent, platformType) {
        return this.flowManager.getFlowByTrigger(trigger, intent, platformType);
    }

    async getFlowByTrigger(profileId, trigger, intent, platformType) {
    ...
    async getProfileFlow(profileId, trigger, intent, platformType) {
    ...
    async subscripeSyncedFlows(flows) {
